...
[![JitPack](https://jitpack.io/v/cloudthink-nj/BLIntercomSdk.svg)](https://jitpack.io/#cloudthink-nj/BLIntercomSdk)
```groovy
...
```groovy
implementation 'com.github.cloudthink-nj:BLIntercomSdk:$latest_version'
```
